...
Next, the time required for inference and training or in the scope of the experiments, finetuning is analysed and shown in \ref{fig: mean_time_taken}. BERT Tiny as expected has the lowest mean training and inference time.
\begin{figure}[htbp]
    \centering
    \captionsetup{font=small}
    \begin{subfigure}{0.49\textwidth}
    ...
    \end{subfigure}
    \caption{Mean time taken for finetuning and inference during experiments set 1. BERTweet with the best predictive model is highlighted in red.}
