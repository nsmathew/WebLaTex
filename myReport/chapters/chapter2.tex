...
While the data selected for this project (described in the subsequent chapter) is selected based on tweets addressed to specific customer handles we also have the 
