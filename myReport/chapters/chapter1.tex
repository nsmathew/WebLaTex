...
\begin{itemize}
    \item Compare the performance of recently introduced variations of the BERT model on the complaint identification task and identify the best performing model.
    \item 'lightweight' BERT based model and analyse the model size to performance variation
    \item Analyse the behvaiour of the model
\end{itemize}
