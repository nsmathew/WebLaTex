...
The best-performing model was found to be BERTweet with an F1 score of 0.908 and accuracy of 0.934, followed by RoBERTa with 0.879 and 0.914 for F1 and accuracy respectively. BERTweet being pre-trained on a corpus of 850M tweets seems to give it a significant advantage in capturing the nuances of social media posts including informal language, typographic errors, use of slang and more specific characteristics of tweets such as use of shorter texts and hashtags. 
