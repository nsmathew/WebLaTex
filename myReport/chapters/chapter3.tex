...
The transformer models used are listed in 
\begin{table}[ht]
    \centering
    \begin{tabularx}{\textwidth}{|X|X|X|}
        \hline
        ...
        \hline
        robberta-base & 125M & https://huggingface.co/roberta-base \\
        \hline
        bert-base-uncased & 110M & https://huggingface.co/bert-base-uncased \\
        \hline
        vinai/bertweet-base & 110M & https://huggingface.co/vinai/bertweet-base \\
        \hline
        distilbert-base-uncased & 66M & https://huggingface.co/distilbert-base-uncased \\
        \hline
        google/mobilebert-uncased & 25.3M & https://huggingface.co/google/mobilebert-uncased \\
        \hline
        albert-base-v2 & 11M & https://huggingface.co/albert-base-v2 \\
        \hline
        prajjwal1/bert-tiny & 4.4M & https://huggingface.co/prajjwal1/bert-tiny \\
        \hline
    \end{tabularx}
