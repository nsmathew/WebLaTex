...
Figure \ref{fig: cross_domain_train_domain} shows how the number of instances or tweets used for the finetuning process affects the mean performance from the testing carried out against all other domains. At a macro level, it appears, the more data that is available for finetuning the better the performance within the constraints of the experiments carried out. WHile certain domains sho We find there is a correlation between the volume of data available vs 