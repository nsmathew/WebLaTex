...
The best performance is where we use all the data except the 'other' domain tweets for finetuning and the 'other' domain for testing. It has a relatively high discriminative ability represented by a AUC score of 0.908 and an F1 0.951. This is followed by 
