...
The domains selected for the dataset are distributed between tweets that forms complaints and those that do not. From Figure \ref{fig: domain_dist_pct}, the top 3 domains are services, software and electronics, making up close to 50\% of the tweets. Looking at \ref{fig: domain_dist_count}, the key observation is the class imbalance within most domains. Also, the no. of tweets within the domains themselves are relatively low in volume. The impact on the predictions are analysed as part of the Experiments set 2 later in this chapter.
