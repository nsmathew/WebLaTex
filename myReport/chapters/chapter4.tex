...
Next, the time required for inference and training (finetuning) is analysed and shown in \ref{fig: mean_time_taken}. BERT Tiny as expected has the lowest mean training and inference time. 
\begin{figure}[htbp]
    \centering
    \captionsetup{font=small}
    \begin{subfigure}{0.49\textwidth}
