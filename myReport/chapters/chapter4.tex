...
Finally, looking at some of the key statistics of the tweets dataset in Table \ref{tab: tweets_statistics}, we find complaint tweets to have a higher average tweet length both in terms of characters and tokens at 77.8 and 16.0 respectively. 
