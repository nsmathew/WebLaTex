...
\subsection{Predictive performance of 'lightweight' models}
Looking at some of the models that are considered lightweight based on their architecture and number of parameters

\subsection{Deep-dive into the results}
**TO UPDATE**

\subsection{Analyis of inference time}
**TO UPDATE**
