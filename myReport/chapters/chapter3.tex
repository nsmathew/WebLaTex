...
The data used for the expriments were created by \cite{preotiuc-pietro_automatically_2019} and further enhanced with severity annotation by \cite{jinModelingSeverityComplaints2021}. This data is annonymised and available in the public domain \footnote{\url{ https://archive.org/details/complaint\_severity\_data}}. No additional data has been collected for this experiment. To ensure the appropriate 
