...
\end{table}
The performance metrics calculated include precision, recall, accuracy, F1, and AOC scores
calculating performance metrics. Finally, the mean of the metrics is calculated.
