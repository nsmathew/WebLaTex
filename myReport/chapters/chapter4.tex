...
\end{table}
What follows are the results from the cross-domain experiments. To recap, in the cross domain experiments the objective is to assess the behaviour of the best performing model from 
