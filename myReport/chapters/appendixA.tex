...
\begin{table}
    ...
    \end{tblr}
    \caption{Confusion matrix from every test run for the experiments set 1. The elements of the matrix are true negative, false positive, false negative and true positive}
