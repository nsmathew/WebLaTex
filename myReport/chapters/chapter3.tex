...
In the first experiment, the objective is to identify which model performs the best for the text classification task for complaints identification and analyse the relative performance between the models
