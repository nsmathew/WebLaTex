...
The data used for the experiments is from Twitter. Twitter provides a good representation of social media text due to the direct connection consumers have with organisations and brands as well as the ability to express oneself \cite{preotiuc-pietro_automatically_2019}. As described in the previous chapter, Twitter provides users with a medium where they can self-express to a high degree while maintaining 
\newline \newline
