...
The Table \ref{tab: model_mean_metrics} also shows the evaluation metrics from \cite{jin_complaint_2020} in []. Although the nested cross-validation is run with a different configuration as described in the previous chapter, it allows for some form of indicative comparison. RoBERTa shows an improved
