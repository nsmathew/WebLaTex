...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \hline
        2 & i wonder how many valid <user> warranties were denied today due to made-up , illegitimate policy . schools aren't commercial property \\
        \hline
        ...
        \hline
        4 & thanks to <user> ' s incompetence i now can't work till october 4th , when the ati card arrives .                                     \\
        \hline
        5 & you jave the worst customer service \! \! \! \#pissed \#useless \#worstbrand                                                             \\
        \hline
    \end{tabularx}
...
Taking examples of complaining in social media from table \ref{tab: ex_complaints}, we find them to be in line with the definition of the act of complaining as described earlier. We find these to show instances of individuals who have experienced a breach of expectations \cite{olshtain_speechact_1987, preotiuc-pietro_automatically_2019}. In terms of the intentions of the individual complaining, we find i
\newline \newline
